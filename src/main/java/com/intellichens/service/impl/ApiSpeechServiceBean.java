...
public class ApiSpeechServiceBean implements ApiSpeechService{
    ...
    private String content1 = new StringBuffer("There are 3 key points\n")
            ...
            .append("\tVR is a technology that has just emerged in the past two years, changing traditional way of information processing.\n")
            .append("\n")
            .append("The uses for VR\n")
    ...
    private String content2 =  new StringBuffer("(Append)\n")
            ...
            .append("\tThe implementation of VR should be under support of some hardware\n")
            .append("\tThere must be a special mechanism to track activities of human eye, such as mobile\n")
            .append("\n")
            .toString();
